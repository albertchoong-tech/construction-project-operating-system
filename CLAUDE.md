...
HSH ProjectOS is an integrated construction project and financial management platform that replaces Excel and WhatsApp by tracking the full lifecycle — from quotation to profitability — for residential construction teams.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "241383100+albertchoong-tech@users.noreply.github.com"
  git config user.name "albertchoong-tech"
  ```
